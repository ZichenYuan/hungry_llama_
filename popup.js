...
async function chatWithLlama(userMessage, systemPrompt = "answer user message") {
    try {
...
document.getElementById('ask-llm').addEventListener('click', async function() {
  ...
  const systemPrompt = "You are an Excel assistant that helps users analyze data and create formulas. Provide concise and helpful responses for Excel-related questions.";
